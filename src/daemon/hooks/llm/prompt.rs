...
pub fn build_crud_prompt(command: &str) -> String {
    // Simple direct prompt - let the system message do the heavy lifting
...
mod tests {
    ...
    fn test_prompt_is_compact() {
        ...
        // Simple prompt should be very short
        assert!(prompt.len() < 50, "Prompt should be compact, was {} chars", prompt.len());
    }
