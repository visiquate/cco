...
**A unified LLM API proxy with automatic cost savings, multi-model routing, and real-time analytics.**
...
1. **[Installation Guide](./docs/installation.md)** - How to install and set up CCO
2. **[Command Reference](./docs/commands.md)** - All CLI commands and options
3. **[Configuration](./docs/configuration.md)** - Configuration files and environment variables
4. **[Troubleshooting](./docs/troubleshooting.md)** - Common issues and solutions
5. **[Features Guide](./docs/features.md)** - Detailed feature documentation

## Support

- Issues: [GitHub Issues](https://github.com/visiquate/cco/issues)
- Documentation: This repository
- Discussions: [GitHub Discussions](https://github.com/visiquate/cco/discussions)
