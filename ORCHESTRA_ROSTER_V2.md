...
Task("Chief Architect", "Analyze requirements and design...", "system-architect", "opus")
Task("Python Specialist", "Implement features...", "python-expert", "sonnet")
Task("Swift Specialist", "Build iOS app...", "ios-developer", "sonnet")
Task("Go Specialist", "Create microservices...", "backend-dev", "sonnet")
Task("Rust Specialist", "Build systems code...", "backend-dev", "sonnet")
Task("Flutter Specialist", "Develop mobile app...", "mobile-developer", "sonnet")
Task("API Explorer", "Explore third-party APIs...", "researcher", "sonnet")
Task("Salesforce Specialist", "Integrate Salesforce...", "backend-dev", "sonnet")
Task("Authentik Specialist", "Setup authentication...", "backend-dev", "sonnet")
Task("Documentation Lead", "Add code comments...", "coder", "haiku")
Task("Technical Writer", "Write architecture docs...", "technical-writer", "sonnet")
Task("UX Designer", "Design and validate UX...", "ux-designer", "sonnet")
