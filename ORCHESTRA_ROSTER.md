...
## Current Roster: 117 Specialized Agents

The Claude Orchestra consists of **117 specialized agents** organized into 12 categories, providing comprehensive coverage for all aspects of software development, operations, research, and business analysis.
...
12. **Support Agents** (20) - QA, testing, UX, performance, operations
...
- **Intelligent Managers** (77 agents): Sonnet 4.5 (complex reasoning, code review, security, architecture)
- **Basic Specialists** (39 agents): Haiku 4.5 (language coding, documentation, utilities)
...
- **Status**: ✅ Operational with 117 agents
...
- ✅ **Model Optimization**: Agents assigned by role complexity
  ...
  - 77 agents using Sonnet 4.5 (intelligent management)
  - 39 agents using Haiku 4.5 (basic coding & utilities)
